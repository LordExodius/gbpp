...
DEPS = global.h CPU.h MMU.h Register.h Cartridge.h Emulator.h Graphics.h catch_amalgamated.hpp Input.h
OBJS = test.o CPU.o MMU.o Register.o Cartridge.o Emulator.o Graphics.o catch_amalgamated.o Input.o
